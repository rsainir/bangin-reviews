 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.bangin.revs.staging
 */

const BUNDLE_ID = 'com.bangin.revs'; // ios bundle id
const PACKAGE = 'com.bangin.revs'; // android package name
const NAME = 'bangin.revs'; // app name
